...
## Deployment to Azure
+ The project is deployed via Azure App Service, published directly from Visual Studio
...
## Architecture
User Browser > index.html (Chat UI) > ChatController (REST API) > FAQBot (Core Logic) > Response
